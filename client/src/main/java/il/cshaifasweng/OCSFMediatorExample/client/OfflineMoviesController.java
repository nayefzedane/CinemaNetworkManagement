...
public class OfflineMoviesController {
    ...
    public void initialize() {
        cinemaComboBox.getItems().addAll("Cinema City", "Yes Planet", "Rav Chen", "Lev Cinema");
        genreComboBox.getItems().addAll("Action", "Drama", "Comedy", "Sci-Fi", "Horror"); // דוגמה לז'אנרים
        ...
        cinemaComboBox.valueProperty().addListener((observable, oldValue, newValue) -> searchMovies());
    ...
    public void searchMovies() {
        ...
        SimpleClient client = SimpleClient.getClient();
        client.requestMoviesByAdvancedCriteria(selectedCinema, startDate, endDate, selectedGenre, movieTitle); // שליחת הבקשה עם כל הקריטריונים
    }
